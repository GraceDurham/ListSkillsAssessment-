...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    foods1 = set(foods1)
    foods2 = set(foods2)
    combined_foods_in_common_list = list(foods1&foods2)

    #sort combined foods
    combined_foods_in_common_list.sort()

    return combined_foods_in_common_list
...
def every_other_item(items):
    ...
    for index in range(0, len(items), 2):
        item = items[index] 
        every_other_items.append(item)
        

    return every_other_items
...
def largest_n_items(items, n):
    ...
    largest_largest_n_items = []

    
    if n > 0:
        items.sort()
        largest_largest_n_items = items[-n:]



    return largest_largest_n_items
